...
if __name__=='__main__':
    ...
    def move(direction, speed=0.2):
        global cur_x, cur_y, sw, sh
        LCD.fill_rect(cur_x,cur_y,10,10,LCD.white)
        ...
        if cur_x > sw or cur_y > sh or cur_x < 0 or cur_y < 0:
            gameover = True
            print("gameover")
            return gameover        

        LCD.fill_rect(cur_x,cur_y,10,10,LCD.blue)
        LCD.show()
        time.sleep(speed)
